...
public:
  ...
  RC create_index(Trx *trx, const FieldMeta *field_meta, const char *index_name, bool Unique) override { return RC::UNIMPLEMENTED; }
  RC create_index(Trx *trx, const vector<const FieldMeta *> &field_metas, const char *index_name, bool Unique) override { return RC::UNIMPLEMENTED; }
